    ...
    def get_all_points_on_line(self):
        ...
        if self.is_horizontal():
            ...
            if a.x < b.x:
                ...
                for x in range(a.x, b.x - 1, -1):
                    x_vals.append(x)
            if a.y < b.y:
                for y in range(a.y, b.y + 1):
                    y_vals.append(y)
            else:
                for y in range(a.y, b.y - 1, -1):
                    y_vals.append(y)
            for i in range(0, len(x_vals)):
                points.append(Vector(str(x_vals[i]) + ',' + str(y_vals[i])))
        return points 
...
minx, miny, maxx, maxy = calculate_area(lines)
